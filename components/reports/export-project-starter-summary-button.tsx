...
interface ExportProjectStarterSummaryButtonProps {
  defaultProjectId?: string
}

export function ExportProjectStarterSummaryButton({
  defaultProjectId
}: ExportProjectStarterSummaryButtonProps = {}) {
  ...
  const runExport = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(mapReportApiErrorFromPayload(payload, "Failed to export project rollout summary"))
      }
      ...
      anchor.href = url
      anchor.download = `project-rollout-summary-${stamp}.md`
      ...
      setError(err instanceof Error ? err.message : "Failed to export project rollout summary")
    } finally {
      setExporting(false)
    }
  }
      ...
      {showDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-full max-w-md rounded-lg border border-gray-200 bg-white p-5 shadow-xl">
            <h3 className="text-lg font-semibold text-gray-900">Export Project Rollout Summary</h3>
